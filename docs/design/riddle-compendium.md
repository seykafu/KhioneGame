# Khione · The Riddle Compendium
### Every riddle on every island, from Ahalo to Agrea

---

## How these riddles are built (the dopamine contract)

Every riddle in Khione follows the same four-beat loop, because this loop is where the joy lives:

1. **Notice.** The player spots something odd in the world. No quest text tells them to. A humming stone, a frozen goose, an escalator running backwards.
2. **Hypothesize.** The environment contains exactly one honest clue (a carving, a shadow, a smell). The player forms a theory.
3. **Test.** Trying costs nothing. Failure is always funny, never punishing: crabs shrug, gulls resettle, pigeons scatter and come back.
4. **Aha.** The world reacts big: something drains, lifts, lights up, sings, or flies. Solving must always be *louder* than trying.

House rules, carried from Ahalo:

- **No lock is text.** Every answer is observable in the world.
- **Each island teaches one new verb or partner trick**, then re-tests the old ones.
- **Every island hides one Oreo artifact** the player cannot decode yet.
- **Every island ends with a letter fragment.** The torn letter is the game's progress bar.
- **Backtracking pays.** Later tools reopen earlier islands' "unsolvable" curiosities.
...
Fragment reward order (chosen for emotional shape, not sentence order):

| Island | Fragment recovered |
|---|---|
| 1 Ahalo | "… one final …" |
...
## Island 1 · Ahalo (implemented)

*Tropical, wild, wordless. Teaches: meow.*

Small riddles, as built: **The Bottle** (interact), **The Three Hollow Stones** (meow the carving's song, smallest voice first), **The Driftwood Seesaw** (coconut counterweights), **The Sundial Reef** (the Sun Shell's shadow picks the true gull rock among decoys).
Main riddle: **Rig the Raft** (oar from the den, frond knocked from the tallest palm, rope traded from the crab for a fish).
Oreo artifact: the Rusty Locket with a too-big pawprint; scratch marks low in the den; the departure pawprints.

---

## Island 2 · The Eaton Centre
*A shopping mall, silent and sunlit, growing out of an island. Escalators still run. Nobody is home. Teaches: hiss.*

**Learning the hiss (opening scene, not a riddle):** an aggressive little floor-cleaning robot corners Khione against a shop window. Cornered, she hisses for the first time. The robot spins around and flees. Lesson installed: *hiss repels machines and pests.*

### Small riddles

**The Wrong-Way Stairs.** The escalators between floors all run against you. Each floor's directory sign lists shop closing times; the escalators reverse direction on the hour, and the analog clock over the fountain is stuck. Solution: the clock is a dial you can move (jump on the hands). Set the clock to a time when the directory says the flower shop waters its window boxes, and the sprinklers, escalators, and fountain all "believe" it is that hour. The aha: the whole mall obeys a broken clock, and now you own the clock.

**The Fountain of Small Wishes.** Coins glitter at the bottom of the fountain. A mosaic on the fountain floor shows three coins in a pattern (heads, heads, tails). Cats push things: paw exactly the mosaic's coins off the ledge into the water, ignore the rest. Push a wrong coin and a pigeon lands on your head (failure = hat). Reward: the drain opens, revealing a brass shop key.

**The Mannequin Quartet.** A shop window holds four mannequins and a dusty poster of a band mid-pose. Rotate each mannequin (rub against the base) to match the poster. The subtle trap: the poster is a mirror image, printed on the window glass. Solving from *inside* the shop makes it obvious. Reward: the drummer mannequin's hand opens, holding the skylight crank handle.

**The Pigeon Parliament.** Pigeons occupy the food court and will not move for a meow. Hissing scatters them, but they resettle one table over. The floor tiles are a grid; the pigeons always resettle *away* from you. Herd them like a sliding puzzle onto the four vent tiles, and their wingbeat over the vents spins a ventilation turbine that blows open a stuck door. Teaches: hiss is not a hammer, it is a steering wheel.

### Main riddle · Make the Flock Fly

The mall's heart is a sculpture of sixty Canada geese frozen mid-flight under a great skylight (every Torontonian knows it). A plaque relief shows geese flying over water, toward a sun.

Phase 1: open the skylight shutters with the crank handle (Mannequin Quartet).
Phase 2: set the stuck clock (Wrong-Way Stairs) to sunset. Low light pours in sideways.
Phase 3: the geese cast shadows for the first time. Sixty shadow-geese land on the floor tiles and form an arrow pointing at a shuttered maintenance door under the escalator that never reversed (the one exception the player has walked past all island).
Phase 4: behind it, the glass elevator. It rises through the skylight to the roof. On the roof: a mall banner, two flagpoles, and the wind. Khione unhooks the banner (claws, finally useful) and hang-glides off the roof toward the next island.

The dopamine: a static sculpture the player assumed was decoration becomes the compass of the whole island, and the escape is *flying with the geese*.

Oreo artifact: in the pet store window, one dog collar on a stand, tag blank but paw-shaped charm identical to the locket engraving. The shop is the one door no key opens. (It opens on a return visit, much later.)
...
## Island 5 · Montréal
*Montréal at autumn dusk: the whole mountain in red maple above a downtown of glass and grey stone, the Bell Centre at the mountain's foot with its four bronze legends, Place Ville Marie's beacon sweeping the sky, a bagel oven still warm, orange cones nobody moved, a calèche horse asleep across the mountain road, endless outdoor staircases, the Musée des beaux-arts at the mountain's foot with one easel standing empty, a chalet with the belvedere view, and the great cross at the summit, dark. Teaches: growl, and vertical patience.*
...
**The Fallen Star.** The last star the scoreboard calls is number 10 — and as the winning horn sounds, a framed portrait of the Démon Blond shakes loose from the rafters and lands flat on the ice. Its little brass plaque reads: *Propriété du Musée des beaux-arts de Montréal — en prêt.* On loan, and overdue. The museum stands at the mountain's east foot, columns and steps, with one easel visible through the door, empty, under a sign: *pièce manquante*. The riddle is the door: the grand handle says TIREZ, and cats cannot pull — but a certain dog can, given a rope and a reason. Hang the portrait where it belongs and the museum lights up warm; the sculpture-garden squirrel, moved by patronage of the arts, returns something its cousins stole: the brass handle of a staircase lever.
...
Phase 3: the swarm circles the cross but will not settle. Fireflies blink in rhythm; they settle only into rhythm. An old drum waits by the cross, its chalk showing a pattern with rests left for an echo: Khione plays it and Oreo barks the answering beats (the duet, one more time), and the whole swarm pulses in sync and pours into the lanterns, tier by tier, lighting the cross like a slow vertical sunrise over the city.
...
*Spare riddle, banked from the Montréal design:* **The Tam-Tam Circle.** Drums abandoned mid-circle on a hillside. Strike a drum and it booms; the mountain answers half a beat later. Play a rhythm that interlocks with its own echo (call and response with the mountain itself); the chalk on the biggest drum shows the pattern with rests exactly where the echo lands. Solving summons every squirrel on the mountain to dance, dropping whatever they were carrying: rain of stolen goods.
...
**The Foghorn Chorus.** Three foghorns sound in the harbour, each a different pitch, each anchored at a different channel mouth. The harbourmaster's chalkboard (readable, half-erased) pairs pitches to channels: "low = shoal, mid = rocks, high = home." In fog, you sail/swim by ear alone. Trust the ears, ignore the eyes: the fog deliberately renders a *false* channel that looks safe. First riddle in the game that is easier with your eyes closed.
...
### Main riddle · Light the Lamp

The lighthouse is intact but dark: no lens, no power, no bearing.

Phase 1: the lens. It went down with a dory off the pier; the Buoy Bells reveal where. Dive for it; it is too heavy for a cat. Oreo swims it in like the retriever he half is.
Phase 2: the power. The keeper's room holds a hand-crank generator with a drum treadmill. Khione runs the wheel (sprint, the only stamina moment in the game, and yes: the fastest cat alive powering a lighthouse). Oreo howls to hold the tempo.
Phase 3: the bearing. The beam through fog hits three mirror buoys; nose each buoy's mirror until the beam threads all three and lands on the harbour mouth. It is the sundial reversed: this time *you* are the sun.
The fog splits along the beam like a curtain. The safe channel out is lit gold. Sail it slow; the game lets the moment breathe.

Oreo artifact: in the keeper's log, pawprints in old ink across one page, as if a dog stepped on the wet entry. The entry date is smudged. The page is bookmarked with a red collar tab.
...
**The Shawarma Discord.** Nine shawarma shops, nine spits, nine nearly identical smells. Whisker Sense renders each as a colour thread. One thread is *wrong*: cold where all others are warm, and it does not come from any shop. Follow it to a bricked-up cellar behind the ninth shop: inside, storm-scorched debris (Tariff vortex wreckage, first physical evidence of the storm from the ending), and pressed in the dust, the big pawprints. The dread and the promise, one island from home. No reward item. The reward is the chill.

**The Tulip Cipher.** Parliament's rose window casts colored light on the lawn each morning. The tulip beds below are planted in mixed colours, but stem-snapped tulips regrow overnight (island magic, stated by a gardener's sign: "They always come back."). Prune each bed until only the window's pattern remains. It is pixel art with flowers, graded at dawn. Reward: the greenhouse opens; inside hangs the lockmaster's lantern.

**The Flame Relay.** The Centennial Flame still burns. The lockmaster's lantern must be lit from it and carried to the canal, but the route crosses six fountains and the wind (old friend) gusts on a kite-less island, unannounced. Route-planning: shop awnings block rain of spray, parked mail trucks block wind, and Oreo can carry the lantern through the one stretch Khione cannot (she jumps a fence; he takes the long way; you plan both). The game's purest "two minds, one problem" moment.

**The Carillon Lesson.** The Peace Tower carillon's practice room is open (window, cat-sized). The practice chime stand has five bells and a wax roll that plays a five-note phrase: the letter's melody, the one that has followed the player since Ahalo, now finally complete with its fifth note (the one the harbour was missing). Learn it here by repetition, Simon-style, no penalty, take all night. This phrase is the final key of the game, and the game makes *sure* your hands know it.

### Main riddle · The Staircase of Water

Eight locks descend to the river. The boat is at the top. The master gate is chained until the carillon plays the evening hymn, and the carillonneur is long gone.

Phase 1: light the lock lanterns (Flame Relay) or the night shift never "starts."
Phase 2: play the letter's melody on the real carillon (Carillon Lesson), Khione on the low bells, Oreo's bark on the one bell rope too stiff for paws. The Peace Tower plays their song over the whole city, and the master chain releases.
Phase 3: descend the eight locks: each lock is a compact remix of an old lesson (a counterweight, a wave-timing, a two-body valve, a hiss-scattered goose blockade, an ear-only fog chamber in the lock tunnel, a wind-shielded flame, a totem-style alignment, and one silent lock that needs nothing: you just wait, together, while the water falls. The game's quietest sixty seconds, on purpose).
The last gate opens at river level. Home is one horizon away.

Oreo artifact: the carillon's guest book. One page, years old: no name, just a muddy pawprint, and beneath it in a child's handwriting the player will recognize in the finale: *"good boy."*
